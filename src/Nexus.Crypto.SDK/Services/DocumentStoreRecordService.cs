...
public class DocumentStoreRecordService(INexusApiClientFactory nexusApiClientFactory, Dictionary<string, string>? headers = null) : BaseService(nexusApiClientFactory, headers), IDocumentStoreRecordService
{
